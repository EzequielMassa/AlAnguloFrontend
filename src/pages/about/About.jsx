                    ...
                    <Col className='d-flex justify-content-center flex-md-row flex-column  pt-2 gap-4' xs={12} md={12}>
                        <div className="card carta">
                            ...
                            <div className="social-icons d-flex flex-row w-100">
                                <Link target="_blank" to={"https://mail.google.com/mail/u/0/#inbox"} className='w-100  '><BsMailbox2Flag className='w-100 icon' /></Link>
                                <Link target="_blank" to={"https://www.linkedin.com/in/tomas-williams-neme-scheij-b60b8a1bb/"} className='w-100'> <BsLinkedin className='w-100 icon' /> </Link>
                                <Link target="_blank" to={"https://www.instagram.com/tomi_williams01/"} className='w-100'><BsGithub className='w-100 icon ' /></Link>
                            </div>
                        </div>
                        <div  className="card carta">
                            ...
                            <p className="card-text">Me considero buen compañero, siempre busco aportar al equipo.
                                ...
                                por el aguante que pusimos todos para llegar a esto.</p>
                            <div className="social-icons d-flex flex-row w-100">
                                <Link target="_blank" to={"https://portfolio-emdev.firebaseapp.com/emdev"} className='w-100  '><BsMailbox2Flag className='w-100 icon' /></Link>
                                <Link target="_blank" to={"https://www.linkedin.com/in/ezequiel-massa-dev/"} className='w-100'> <BsLinkedin className='w-100 icon' /> </Link>
                                <Link target="_blank" to={"https://github.com/EzequielMassa"} className='w-100'><BsGithub className='w-100 icon ' /></Link>
                            </div>
                        </div>
